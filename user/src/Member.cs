...
namespace Tokenio.User {
	...
	public class Member : Tokenio.Member {
		...
		/// <param name="transferTokenBuilder">transferTokenBuilder transfer token builder</param>
		...
		/// <summary>
		/// Removes all public keys that do not have a corresponding private key stored on the current device from the member.
		/// </summary>
		...
		/// <summary>
		/// Removes the non stored keys blocking.
		/// </summary>
		...
		/// <returns>indicates whether the operation finished or had an error</returns>
		...
		/// <summary>
		/// Creates the test bank account in a fake bank and links the account.
		/// </summary>
		/// <returns>The linked account blocking.</returns>
		/// <param name="balance">Balance.</param>
