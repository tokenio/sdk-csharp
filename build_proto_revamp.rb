...
#
TOKEN_PROTOS_VER = "1.1.94"
RPC_PROTOS_VER = "1.1.38"
FANK_PROTOS_VER = "1.1.0"
GATEWAY_PROTOS_VER = "1.1.15"
...
file << open(url, :http_basic_authentication => ['vanika.appperfect', 'App4ever$']).read
end
end
file
end
...
test_dir = "./sdk-csharp-tests/generated"
...
generate_protos_cmd("fank/fank", test_dir) + 
generate_protos_cmd("gateway", core_dir);
